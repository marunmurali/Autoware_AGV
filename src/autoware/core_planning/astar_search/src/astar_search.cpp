...
AstarSearch::AstarSearch()
{
  ...
  // robot configs
  private_nh_.param<double>("robot_length", robot_length_, 0.5); //change 1 [4.5]
  private_nh_.param<double>("robot_width", robot_width_, 0.5); // change 2 [1.75]
  private_nh_.param<double>("robot_base2back", robot_base2back_, 0.05); // Change 3 [1.0]
  private_nh_.param<double>("minimum_turning_radius", minimum_turning_radius_, 0.25); //[6.0]
//added lines arun
private_nh_.setParam("robot_length",  0.5);
private_nh_.setParam("robot_width", 0.5);
private_nh_.setParam("robot_base2back", 0.05);
private_nh_.setParam("minimum_turning_radius", 0.25);
//added lines arun end
  // search configs
